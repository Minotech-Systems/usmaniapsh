<div class="container">
    <div class="row">
        <div class="col-md-2 col-sm-2" style="border-left: dashed 1px black;">
            ...
            <a href="<?php echo base_url('website/dashboard/jamia_tasees'); ?>"
               class="btn btn-<?php echo $page_content == 'jamia_tasees' ? 'info' : 'default'; ?> btn-block" style="text-align:right; padding-right: 15px;margin-top: 10px;">
                <i class="fa fa-home"></i>
                <?php echo get_phrase('jamia_tasees'); ?>
            </a>
