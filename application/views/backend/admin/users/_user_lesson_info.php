...
$data = $this->admin_model->get_user_lesson_question_data($user_id, $lesson_id);
...
$lesson_data = $this->db->get_where('ifta_chapter_lessons', array('lesson_id' => $lesson_id))->row();
?>
<style>
    li{text-align: right}
</style>
<div class="row">
    ...
    <div class="col-md-4">
        <div class="tile-stats tile-gray">
            ...
            <h4 style="text-align: center; color: #8f8f8f"><?= 'صنف : ٰ' . $lesson_data->name ?></h4>
        </div>
    </div>
    <div class="col-md-4"></div>
</div>
