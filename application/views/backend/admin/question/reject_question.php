                        ...
                        <td>
                            <div class="btn-group">      
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <li>  
                                        <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>admin/users/delete/<?= '' ?>')">   
                                            <i class="entypo-trash"></i>     
                                            <?php echo get_phrase('delete'); ?>        
                                        </a>  
                                    </li>
                                    <li>  
                                        <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>questions/reject_question/un_reject/<?= $ques->question_id ?>')"> 
                                            <i class="entypo-block"></i>     
                                            <?php echo get_phrase('un_reject'); ?>        
                                        </a>  
                                    </li>
                                    <li>  
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modals/reject_email/<?= $ques->question_id ?>');">
