        ...
        <div class="panel panel-primary" > 
            ...
            <div class="panel-body">                                     
                <table class="table table-bordered datatable" id="table_export1"> 
                    ...
                    <tbody>
                        <?php
                        $count = $this->places_model->get_countries();
                        $no = 1;
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">    
                                            <!-- EDITING LINK -->        
                                            <li>                                 
                                                <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/places_modal/modal_country_edit/<?php echo $data['country_id']; ?>');">        
        ...
        <div class="panel panel-primary" > 
            ...
            <div class="panel-body">                                     
                <table class="table table-bordered datatable1" id="table_export"> 
                    ...
                    <tbody>
                        <?php
                        $prov = $this->places_model->get_provinces();
                        $no = 1;
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">    
                                            <!-- EDITING LINK -->        
                                            <li>                                 
                                                <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/places_modal/modal_province_edit/<?php echo $data1['prov_id']; ?>');">        
                                                    <i class="entypo-pencil"></i>  
                                                        <?php echo get_phrase('edit'); ?>    
                                                </a>                                      
                                            </li>
