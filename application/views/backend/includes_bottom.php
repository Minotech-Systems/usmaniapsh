...
<script src="<?= base_url('assets/js/wysihtml5/wysihtml5-0.4.0pre.min.js') ?>"></script>
<script src="<?= base_url('assets/js/wysihtml5/bootstrap-wysihtml5.js') ?>"></script>

<script src="<?= base_url('assets/js/ckeditor/ckeditor.js') ?>"></script>
<script src="<?= base_url('assets/js/ckeditor/adapters/jquery.js') ?>"></script>

<script src="<?= base_url('assets/js/ajax_form_submission.js') ?>"></script>
