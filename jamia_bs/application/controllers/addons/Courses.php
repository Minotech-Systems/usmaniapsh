...
//    }
  ...
  public function index($param1 = '', $param2 = ''){
    ...
    if(empty($param1)){
      ...
      $page_data['all_teachers']           = $this->user_model->get_teachers();//$this->user_model->get_all_teachers();
...
//    $this->student_access_denied();
    $page_data['all_teachers']    = $this->user_model->get_teachers();
    $page_data['classes']     = $this->crud_model->get_classes();
    $page_data['folder_name'] = 'academy';
  ...
  public function ajax_get_video_details() {
    $video_details = $this->video_model->getVideoDetails(html_escape($_POST['video_url']));
    echo $video_details['duration'];
  }

  public function ajax_sort_section() {
    $section_json = html_escape($this->input->post('itemJSON'));
