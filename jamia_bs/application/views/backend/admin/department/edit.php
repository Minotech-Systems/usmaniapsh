    ...
    <form method="POST" class="d-block ajaxForm" action="<?php echo route('department/update/' . $param1); ?>">
        <div class="form-row">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" value="<?php echo $department['comment']; ?>" id="comment" name = "comment" required>
                <small id="name_help" class="form-text text-muted"><?php echo get_phrase('provide_comment'); ?></small>
            </div>
            <div class="form-group  col-md-12">
