          ...
          <div class="card-body">
            ...
            <div class="text-center">
              <h3 class="font-weight-normal text-white mb-2">
                <?php echo '20'//$this->crud_model->get_todays_attendance(); ?>
              </h3>
              <p class="text-light text-uppercase font-13 font-weight-bold"><?php echo '100' //$this->crud_model->get_todays_attendance(); ?> <?php echo get_phrase('students_are_attending_today'); ?></p>
