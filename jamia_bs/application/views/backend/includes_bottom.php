...
<!--Notify for ajax-->
<script src="<?php echo base_url(); ?>assets/backend/js/ajax/toastr.min.js"></script>

<script src="<?php echo base_url(); ?>assets/backend/js/ajax/jquery.validate.min.js"></script>
<script src="<?php echo base_url(); ?>assets/backend/js/ajax/additional-methods.min.js"></script>
<!-- demo app -->
