...
<?php echo form_open(base_url() . 'index.php?newadmission/new_admit_students_report/'); ?>
<div class="row">
...
<?php if (!empty($branch_id1)) { ?>
    <div class="row">
        <div class="col-md-4">
            <a href="<?= base_url('index.php?newadmission/print_admit_student_report/'.$branch_id1) ?>" target="blank" class="btn btn-success">
