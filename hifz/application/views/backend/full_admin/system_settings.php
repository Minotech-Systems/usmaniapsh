    ...
    <div class="col-md-6">                
        <div class="panel panel-primary" > 
            ...
            <div class="panel-body"> 
                ...
                <div class="form-group">                     
                    <label  class="col-sm-3 control-label"><?php echo get_phrase('talimi_saal'); ?></label> 
                    <div class="col-sm-9">                          
                        <select name="talimi_saal" class="form-control selectboxit">    
                            <?php $talimi_saal = $this->db->get_where('settings', array('type' => 'talimi_saal'))->row()->description; ?> 
                            <option value=""><?php echo get_phrase('talimi_saal'); ?></option>   
                            <?php for ($i = 20; $i < 50; $i++): ?>                             
                                <option value="<?php echo $i; ?>"
                                        <?php if ($talimi_saal ==  $i) echo 'selected'; ?>>     
                                    <?php echo ($i);?>                             
                                </option>                       
                            <?php endfor; ?>                         
                        </select>
...
<script type="text/javascript">  
    $(".gallery-env").on('click', 'a', function () {  
        skin = this.id; $.ajax({          
            url: '<?php echo base_url(); ?>index.php?admin/system_settings/change_skin/' 
                    + skin, success: window.location = '<?php echo base_url(); ?>index.php?admin/system_settings/'     
        }); });
        </script>