...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            <select class="form-control" name="branch_id" id="branch" onchange="goToURL(this.value); return false;" >
                <option value=""><?= get_phrase('select_branch') ?></option>
                <?php
                $branches = $this->db->get('branches')->result();
                foreach ($branches as $data) {
                    ?>
                    <option value="<?= $data->branch_id ?>" ><?= $data->name ?></option>
                <?php } ?>
            </select>
        </div>
    </div>
    ...
    <tbody>
        ...
        foreach ($teachers as $tech) {
            ...
            <tr>
                ...
                <td><?= $this->crud_model->get_column_name_by_id('branches','branch_id',$tech->branch_id)?></td>
                <td>
                    <div class="btn-group">      
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>  
                                <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/teacher/modal_edit_teacher/<?php echo $tech->teacher_id; ?>/<?= $tech->branch_id?>');">       
                                    <i class="entypo-pencil"></i>     
                                    <?php echo get_phrase('edit'); ?>   
                                </a>  
                            </li>
                            <li>  
                                    <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?full_admin/teacher/delete/<?php echo $tech->teacher_id.'-'.$tech->branch_id; ?>');">   
...
<script type="text/javascript">
    function goToURL(id) {
        location.href = "<?php echo base_url(); ?>index.php?full_admin/teacher/" + id;
    }
</script>