...
foreach ($edit_data as $data) {
    ?>
    <?php echo form_open(base_url() . 'index.php?full_admin/teacher/update/'.$param2.'-'.$param3, array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
