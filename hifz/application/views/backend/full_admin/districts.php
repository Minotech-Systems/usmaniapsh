        ...
        <div class="panel panel-primary" > 
            ...
            <div class="panel-body">                                     
                <table class="table table-bordered datatable" id="table_export1"> 
                    ...
                    <tbody>
                        <?php
                        $district  = $this->crud_model->get_table_data('district');
                        $no = 1;
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">    
                                            <!-- EDITING LINK -->        
                                            <li>                                 
                                                <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/modals/modal_district_edit/<?php echo $data1['dist_id']; ?>');">        
