                    ...
                    <tbody>
                        ...
                        if (!empty($query)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-danger" onclick="confirm_modal('<?php echo base_url(); ?>index.php?exam/exam_roll/delete/<?php echo $running_year ?>');">
                ...
                <div class="box-content">
                    ...
                    <div class="padded">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo get_phrase('starting_number'); ?></label>
                            <div class="col-sm-5">
                                <input type="number" class="form-control"  name="starting_num" data-validate="required" placeholder="<?= get_phrase('starting_number') ?>" data-message-required="<?php echo get_phrase('value_required'); ?>"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
