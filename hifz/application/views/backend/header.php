<style>
    ...
    @media (max-width: 768px) {
        .page-container .main-content{padding: 20px;}
        #head_link{margin-top: 15px;}
    }
</style>
<div class="row" style="margin-right:0px; margin-left: 0px;">
    <div class="col-md-12 col-sm-12 clearfix" style="text-align:center;">
        <h3 style="font-weight:200; margin:0px;" dir="ltr">
            <?php
            if ($this->session->userdata('user_level') != 0) {
                echo $this->crud_model->get_system_branch($this->session->userdata('branch_id'));
            } else {
                echo $system_name;
            }
    ...
    <div class="col-md-12 col-sm-12 clearfix ">
        ...
        <ul class="list-inline links-list pull-left" id="head_link">
            <!-- Language Selector -->
