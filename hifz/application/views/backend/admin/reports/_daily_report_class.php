...
<div class="row" style="text-align: center">
    <a class="btn btn-success" href="<?= base_url('index.php?exam/print_daily_class_report/' . $teacher_id . '/' . $month) ?>" target="blank">
...
foreach ($student_data as $std_data) {
    ...
    <div class="row">
        <div class="col-m-12">
            <center>
                <h4><?= 'ماہانہ رپورٹ حافظ' . ' : ' ?><?= $std_data->name . ' | ' . ' ولدیت' . ' ' . $std_data->father_name . ' | ' . 'ماہ' . ' ' . $month_name ?></h4>
            </center>
        </div>
    </div>
