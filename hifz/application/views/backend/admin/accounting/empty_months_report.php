...
<?php echo form_open(base_url() . 'index.php?student_fee/empty_months_report/'); ?>
<div class="row">
...
if ($teacher_id != '') {
        ...
        <div class="col-md-4" style="text-align: center;">
            <div class="tile-stats tile-gray">
                ...
                <?php if (is_numeric($teacher_id)) { ?>
                    <br>
                    <h3><?= $this->db->get_where('teacher', array('teacher_id' => $teacher_id))->row()->name; ?></h3>
                <?php } ?>
    ...
    <div class="row">
        <center>
            <a href="<?php echo base_url(); ?>index.php?student_fee/empty_months_report_print/<?php echo $teacher_id ?>/<?php echo $month ?>" target="_blank" class="btn btn-success btn-icon icon-left hidden-print ">
