<html>
    ...
    <body>
        ...
        $student_info = $this->studentfee_model->get_students_fee($teacher_id, $running_year);
        $no = 0;
        foreach ($student_info as $data) {
            $student_id = $data['student_id'];
            $no++;
            $parentName = $data['father_name'];
                            ...
                            ?>>
                                ...
                                <table width="100%"  dir="rtl" style=" line-height: 2.3; border: 1px solid #dadada; border-collapse: collapse; margin-top: 20px; font-size: 10px;" border="1" id="data_table">
                                    <tr>
                                        ...
                                        <td><?= 'رجسٹریشن نمبر:' ?><span><?= $data['reg_no']; ?></span></td>
                                    </tr>
                                    <tr>
                                        <td><?= 'نام طالب علم:' ?></td>
                                    ...
                                    <tr>
                                        <td><?= 'ولدیت:' ?></td>
                                        <td style="font-weight:bold"><?= $parentName ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <table style="text-align: center;line-height: 2;font-size: 10px; font-weight: bold; border: 1px solid black; border-collapse: collapse" border="1" width="100%" align='center'>
                                                <tr>
                                                    ...
                                                    <td align="center"><?= $monthly_fee = $this->db->get_where('monthly_fee', array('branch_id' => $branch_id, 'year' => $running_year))->row()->amount; ?>
                                                    </td>
                                                    <td><?= 'تفصیل' ?></td>
                                                    <td><?= 'ٹوٹل رقم' ?></td>
                                ...
                                <table width="100%"  dir="rtl" style="line-height: 2;border: 1px solid black; border-collapse: collapse;  text-align: center; font-size: 10px;" border="1" >
                                    ...
                                    <tr>
                                        <td><?php
                                            ...
                                            $four_paid = $this->studentfee_model->get_student_transactions_sum(1, 4, $student_id, $teacher_id);
                                        ...
                                        <td><?php
                                            ...
                                            $where['year'] = $running_year;
                                            if (end($months) > 4) {
                                                $four_paid1 = $this->studentfee_model->get_student_transactions_sum(5, 8, $student_id, $teacher_id);
                                        ...
                                        <td><?php
                                            ...
                                            $where['year'] = $running_year;
                                            if (end($months) > 8) {
                                                $four_paid2 = $this->studentfee_model->get_student_transactions_sum(9, 12, $student_id, $teacher_id);
