...
<div class="row">
    <div class="col-md-12">
        <center>
            <form action="<?= base_url('index.php?hostel/add_room_leader') ?>" method="post">
                            ...
                            <td colspan="2" align="center">
                                <div class="col-sm-6 col-sm-offset-2">
                                    <div class="form-group">
                                        <label class="control-label" style="margin-bottom: 5px;"><?= 'منتخب امیر' ?></label>
                                        <select name="leader_id" class="form-control ">
                                            <option value=""><?php echo 'امیر منتخب کریں'; ?></option>
                                            <?php
                                            ...
                                            foreach ($students as $std_data) {
                                                ...
                                                ?>
                                                <option value="<?= $std_data->id; ?>" <?php if ($std_data->leader == 1) echo 'selected'; ?>><?= $name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
