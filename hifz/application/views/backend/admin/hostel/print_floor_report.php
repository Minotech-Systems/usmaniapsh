<html>
    ...
    <body>
        ...
        <?php
        $floors = $this->db->get_where('hostel_floor', array('hostel_id' => $hostel_id, 'id' => $floor_id))->result();
                ...
                <table width="80%"  align="center" border="1" dir="rtl" style="line-height: 1.5; font-size: 18px; font-weight: bold; border:1px solid black; border-collapse: collapse; text-align: center;">
                    ...
                    foreach ($floor_students as $student) {
                        ...
                        <tr>
                            ...
                            <td><?=
                                $this->db->get_where('class', array('class_id' => $student->class_id))->row()->name . '(' .
                                $this->db->get_where('section', array('section_id' => $student->section_id))->row()->name . ')';
                                ?>
                            </td>
                            <td>
                                <?php
