...
<?php
if ($login_user_branch == 0) {
    $sponsers = $this->db->get('students_sponsor')->result_array();
} else {
    $sponsers = $this->db->get_where('students_sponsor', array('branch_id' => $login_user_branch))->result_array();
}
?>
<hr />
<div class="row">
                            ...
                            <div class="col-sm-5">
                                <select name="branch_id" class="form-control "  >
                                    ...
                                    if ($login_user_level == 0) {
                                        ...
                                        $branches = $this->db->get_where('branches', array('branch_id' => $login_user_branch))->result_array();
                                    }

                                    foreach ($branches as $row):
                                        ?>
                                        <option value="<?php echo $row['branch_id']; ?>"
    <?php if ($login_user_branch == $row['branch_id']) echo 'selected'; ?>><?php echo $row['name']; ?></option>
<?php endforeach; ?>
                                </select>
                            </div>
                        </div>
