...
<div id="print">
    ...
    foreach ($students as $row) {
        ...
        $image = $row->image;
        $section = $this->db->get_where('section', array('section_id' => $row->section_id))->row()->name;
        ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td rowspan="4" align="left">
                                                <img src="<?php echo $this->crud_model->get_image_url('student', $image); ?>" width="55" height="63"/>
                                                <br>
                                        ...
                                        <tr>
                                            <td style="padding-left: 5px;" colspan="2">
                                                <strong>
                                                    <?php
                                                    echo get_phrase('parent') . ' : &nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $row->father_name;
                                                    ?>
                                                </strong>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="padding-left: 5px;" colspan="2">
                                                <strong><?php
                                                    echo get_phrase('class') . ' : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . $this->crud_model->get_class_name($row->class_id) . ' (' . $section . ')';
                                                    ?>
                                                </strong>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="padding-left: 5px; font-size: 8px;" colspan="4">
                                                <?php
                                                echo '<strong>' . get_phrase('current_address') . '</strong>' . ' : ' . $row->c_address;
                                                ?>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="padding-left: 5px; font-size: 8px;" colspan="4">
                                                <?php
                                                echo '<strong>' . get_phrase('permanent_address') . '</strong>' . ' : ' . $row->p_address;
                                                ?>
                                            </td>
