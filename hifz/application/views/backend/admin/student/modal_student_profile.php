<?php  $edit_data = $this->db->get_where('student',array('student_id'=>$param2))->result();
foreach ($edit_data as $data){
   ?>
<div class="row">
    <div class="col-md-10 col-md-offset-1 col-sm-12">
        <img class="img-circle" src="<?= $this->crud_model->get_image_url('student', $data->image); ?>" width="90">
    </div>
</div>
<div class="row">
