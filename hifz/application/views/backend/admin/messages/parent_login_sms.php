<?php echo form_open(base_url() . 'index.php?message/send_parent_login_sms', array('class' => 'form-wizard validate', 'id' => 'rootwizard-2', 'enctype' => 'multipart/form-data', 'target' => '_top'));
?>
<div class="row">
    <div class="col-sm-3">
        ...
        <div class="form-group">
            <div class="">
                <textarea class="form-control" name="message" rows="8" dir="rtl" style="line-height: 2.5">
<?= '  خوشخبری! آپ کا برخوردارفی الحال جامعہ عثمانیہ پشاور میں زیر تعلیم ہے۔جامعہ کی طرف سے آپ کو یہ سہولت دی جاتی ہے۔  کہ آپ کہی سے بھی اپنے بیٹے کی یومیہ اور شب ہفتہ حاضری،  ماہانہ ٹسٹ، طالب علم کا فیس اور اسباق کی رپورٹ دیکھ سکتے ہو۔                '?>
